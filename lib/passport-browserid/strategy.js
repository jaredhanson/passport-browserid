...
Strategy.prototype.authenticate = function(req) {
  ...
  try {
    ...
    /*
    var bia = jwcrypto.cert.unbundle(assertion);
    console.log(bia);
    ...
    */
    ...
    var now = new Date();
    jwcrypto.cert.verifyBundle(assertion, now, pki.root, function(err, certParamsArray, payload, assertionParams) {
      if (err) { return self.error(err); }
    
      console.log('VERIFIED ASSERTION!');
      //console.log(certParamsArray);
      //console.log(payload);
      //console.log(assertionParams);
    
      //console.log(util.inspect(certParamsArray, true, null));
      //console.log(util.inspect(payload, true, null));
      //console.log(util.inspect(assertionParams, true, null));
    });
  } catch (ex) {
